...
* Test Steps
  ...
  4. Check on the Bulh departure and choose the type of arrival distribution from the dropdown displayed 
  5. Enter the departure size value and click on start button
