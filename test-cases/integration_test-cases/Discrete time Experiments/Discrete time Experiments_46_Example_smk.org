...
* Objective
  - To view the Example 7 of  “Discrete time Experiments” experiment
...
* Post conditions
  - Nil
* Test Steps
  1. Click on the “Example 7” link 
  2. A pdf page should be opened with the Example 7

* Expected result
  1. Example 7 page should be opened
