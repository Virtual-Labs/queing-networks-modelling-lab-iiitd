...
* Objective
  - To view the Example 6 of  “Discrete time Experiments” experiment
...
* Post conditions
  - Nil
* Test Steps
  1. Click on the “Example 6” link 
  2. A pdf page should be opened with the Example 6

* Expected result
  1. Example 6 page should be opened
