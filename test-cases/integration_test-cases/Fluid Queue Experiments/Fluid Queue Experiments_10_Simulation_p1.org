...
* Test Steps
  ...
  3. Enter the invalid  values in inflow rates,outflow rates,arrival rate, departure rate,buffer capacity and number of states
  4. Click on start button

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. An error message should be displayed on the screen as to enter the valid inflow rates,outflow rates,arrival rate, departure rate,buffer capacity and number of states values
