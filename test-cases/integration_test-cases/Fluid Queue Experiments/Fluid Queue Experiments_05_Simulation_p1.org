...
* Expected result
  ...
  3. An error message should be displayed on the screen as to enter the valid values in inflow rates,outflow rates,arrival rate, departure rate and number of states fields
